    ...
    init() {
        if (!localStorage.getItem(this.KEYS.USERS)) {
            localStorage.setItem(this.KEYS.USERS, JSON.stringify([
                { id: 'USR-001', email: 'user@example.com',      password: '***',   name: 'Ayush Sharma',    role: 'Admin',       department: 'Management',     lastLogin: '2026-07-12' },
                { id: 'USR-002', email: 'user@example.com',      password: '***',   name: 'Rahul Verma',     role: 'Clerk',       department: 'Operations',     lastLogin: '2026-07-11' },
                { id: 'USR-003', email: 'user@example.com',    password: '***', name: 'Priya Mehta',     role: 'Manager',     department: 'Credit',         lastLogin: '2026-07-10' }
            ]));
        }
